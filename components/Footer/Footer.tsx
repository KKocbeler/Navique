        ...
        <footer className='bg-slate-950 mt-auto pt-8'>
            <div className='new-container relative sm:static'>
                <div className='w-[350px] text-center mx-auto mb-20 sm:mb-8 '>
                    <div className="text-3xl mb-1  text-slate-100">Contect with us!</div>
                    ...
                    <div className='flex flex-1 justify-center gap-4 text-[20px] absolute bottom-[50px] left-1/2 -translate-x-1/2 sm:static sm:-translate-x-0 sm:left-0 sm:bottom-0'>
                        {
                            socialLinks.map((social, index) => (
                                <Link href={'#'} className='text-slate-300 hover:text-slate-100 transition' key={index}>{React.createElement(social)}</Link>
                            ))
                        }
                    </div>
